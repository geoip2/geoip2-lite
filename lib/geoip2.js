...
var dataFiles = {
	city: path.join(geodatadir, 'geoip2-city.dat'),
	city6: path.join(geodatadir, 'geoip2-city6.dat'),
	cityNames: path.join(geodatadir, 'geoip2-city-names.dat'),
	country: path.join(geodatadir, 'geoip2-country.dat'),
	country6: path.join(geodatadir, 'geoip2-country6.dat')
};
